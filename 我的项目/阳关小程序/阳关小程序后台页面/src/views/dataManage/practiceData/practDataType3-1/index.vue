<template>
  <div class="app-container">
    ...
    <el-table v-loading="tab_loading" border :data="tableData" style="width: 100%" max-height="550">
      ...
      <el-table-column prop="stime" label="练习开始时间" header-align="center" align="center"></el-table-column>
      <el-table-column prop="etime" label="练习结束时间" header-align="center" align="center"></el-table-column>
      <el-table-column prop="ltime" label="练习时长" header-align="center" align="center"></el-table-column>
      <el-table-column prop="bad_time" label="1" header-align="center" align="center" width="300"></el-table-column>
      <el-table-column prop="bad_do_what" label="2" header-align="center" align="center" width="300"></el-table-column>
      <el-table-column prop="good_time" label="3" header-align="center" align="center" width="300"></el-table-column>
      
      <el-table-column label="4" class-name="cust-column" header-align="center" align="center">
        <template slot-scope="scope">
          <div class="cust-cell" v-for="(item,i) in scope.row.good_do_what_arr" :key="i">
            {{item || "&nbsp;"}}
          </div>
        </template>
      </el-table-column>
      <el-table-column label="5" class-name="cust-column" header-align="center" align="center">
        <template slot-scope="scope">
          <div class="cust-cell" v-for="(item,i) in scope.row.good_activity_arr" :key="i">
            {{item || "&nbsp;"}}
          </div>
        </template>
      </el-table-column>
      <el-table-column label="6" class-name="cust-column" header-align="center" align="center">
        <template slot-scope="scope">
          <div class="cust-cell" v-for="(item,i) in scope.row.want_activity_arr" :key="i">
            {{item || "&nbsp;"}}
          </div>
        </template>
      </el-table-column>
...
<script>
import { activity_record_answer, excel_activity_record_answer } from "@/api/dataManage/practData";
