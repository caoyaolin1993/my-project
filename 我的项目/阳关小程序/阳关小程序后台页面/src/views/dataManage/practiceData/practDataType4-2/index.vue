      ...
      <el-table-column label="周一" align="center">
        ...
        >
          <template slot-scope="scope">
            <div
              class="cust-cell"
              v-for="(item, i) in scope.row.info['周一']"
              :key="i"
            >
              {{ item.time || "&nbsp;" }}
            </div>
      ...
      <el-table-column label="周二" align="center">
        ...
        >
          <template slot-scope="scope">
            <div
              class="cust-cell"
              v-for="(item, i) in scope.row.info['周二']"
              :key="i"
            >
              {{ item.time || "&nbsp;" }}
            </div>
      ...
      <el-table-column label="周三" align="center">
        ...
        >
          <template slot-scope="scope">
            <div
              class="cust-cell"
              v-for="(item, i) in scope.row.info['周三']"
              :key="i"
            >
              {{ item.time || "&nbsp;" }}
            </div>
      ...
      <el-table-column label="周四" align="center">
        ...
        >
          <template slot-scope="scope">
            <div
              class="cust-cell"
              v-for="(item, i) in scope.row.info['周四']"
              :key="i"
            >
              {{ item.time || "&nbsp;" }}
            </div>
      ...
      <el-table-column label="周五" align="center">
        ...
        >
          <template slot-scope="scope">
            <div
              class="cust-cell"
              v-for="(item, i) in scope.row.info['周五']"
              :key="i"
            >
              {{ item.time || "&nbsp;" }}
            </div>
      ...
      <el-table-column label="周六" align="center">
        ...
        >
          <template slot-scope="scope">
            <div
              class="cust-cell"
              v-for="(item, i) in scope.row.info['周六']"
              :key="i"
            >
              {{ item.time || "&nbsp;" }}
            </div>
      ...
      <el-table-column label="周日" align="center">
        ...
        >
          <template slot-scope="scope">
            <div
              class="cust-cell"
              v-for="(item, i) in scope.row.info['周日']"
              :key="i"
            >
              {{ item.time || "&nbsp;" }}
            </div>
