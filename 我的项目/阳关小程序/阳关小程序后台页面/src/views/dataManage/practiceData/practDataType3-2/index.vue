<template>
  <div class="app-container">
    ...
    <el-table v-loading="tab_loading" border :data="tableData" style="width: 100%" max-height="550">
      ...
      <el-table-column prop="activity_arr" label="活动宝箱" header-align="center" align="center" width="300"></el-table-column>
    </el-table>
...
<script>
import { activity_keys, excel_activity_keys } from "@/api/dataManage/practData";
