<template>
  <div class="app-container">
    ...
    <el-table v-loading="tab_loading" border :data="tableData" style="width: 100%" max-height="550">
      ...
      <el-table-column prop="task" label="任务" header-align="center" align="center" width="300"></el-table-column>
      <el-table-column label="分解步骤" class-name="cust-column" header-align="center" align="center">
        <template slot-scope="scope">
          <div class="cust-cell" v-for="(item,i) in scope.row.info['dec']" :key="i">
            {{item.steps}}
          </div>
        </template>
      </el-table-column>
      <el-table-column label="预期难度" class-name="cust-column" header-align="center" align="center">
        <template slot-scope="scope">
          <div class="cust-cell" v-for="(item,i) in scope.row.info['dec']" :key="i">
            {{item.difficulty || "&nbsp;"}}
          </div>
      ...
      <el-table-column label="完成时间" class-name="cust-column" header-align="center" align="center">
        <template slot-scope="scope">
          <div class="cust-cell" v-for="(item,i) in scope.row.info['dec']" :key="i">
            {{item.ctime || "&nbsp;"}}
          </div>
...
<script>
import { taskDecomposition, excel_taskDecomposition } from "@/api/dataManage/practData";
