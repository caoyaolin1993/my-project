<template>
  <div class="app-container">
    ...
    <el-table v-loading="tab_loading" border :data="tableData" style="width: 100%" max-height="550">
      ...
      <el-table-column label="思维误区" class-name="cust-column" header-align="center" align="center">
        <template slot-scope="scope">
          <div class="cust-cell" v-for="(item,i) in scope.row.info" :key="i">
            {{item.think_error}}
          </div>
        </template>
      </el-table-column>
      <el-table-column label="比例" class-name="cust-column" header-align="center" align="center">
        <template slot-scope="scope">
          <div class="cust-cell" v-for="(item,i) in scope.row.info" :key="i">
            {{item.ratio || "&nbsp;"}}
          </div>
...
<script>
import { myth_proportion, excel_myth_proportion } from "@/api/dataManage/practData";
