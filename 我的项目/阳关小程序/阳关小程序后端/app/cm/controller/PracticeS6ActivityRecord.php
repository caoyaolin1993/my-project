...
class PracticeS6ActivityRecord extends cmPrefix
{
    /**
     * 显示资源列表
     *
    ...
    public function index()
    {
        ...
        $res = S6ActivityRecord::where('open_id', $open_id)->field('stime')->order('stime')->group('stime')->select()->toArray();
    ...
    public function save(Request $request)
    {
        ...
        try {
            Db::transaction(function () use ($list) {
                $s6ActivityRecord = app('s6ActivityRecord');
                $s6ActivityRecord->saveAll($list);
            });
    ...
    public function read()
    {
        ...
        $res = S6ActivityRecord::where(['open_id' => $open_id, 'stime' => $stime])->where('activity', '<>', '')->field('date,time,activity,pleasure,achievement')->select()->toArray();
        $arr = [];
        foreach ($res as $value) {
            $arr[] = [
    ...
    public function update(Request $request)
    {
        ...
        $res = S6ActivityRecord::where(['open_id' => $open_id, 'stime' => $stime])->field('etime,ltime,new,type')->find()->toArray();
        ...
        try {
            Db::transaction(function()use($list,$open_id,$stime){
                S6ActivityRecord::destroy(function($query)use($open_id,$stime){
